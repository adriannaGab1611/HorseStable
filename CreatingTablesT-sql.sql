...
-- Reference: Wlasciciel_klub_Klub_jezdziecki (table: Wlasciciel_klub)
ALTER TABLE Wlasciciel_klub ADD CONSTRAINT Wlasciciel_klub_Klub_jezdziecki
    FOREIGN KEY (Klub_jezdziecki_ID)
    REFERENCES Klub_jezdziecki (ID);

-- Reference: Wlasciciel_klub_Wlasciciel_konia (table: Wlasciciel_klub)
ALTER TABLE Wlasciciel_klub ADD CONSTRAINT Wlasciciel_klub_Wlasciciel_konia
    FOREIGN KEY (Wlasciciel_konia_ID)
    REFERENCES Wlasciciel_konia (ID);
...
INSERT INTO kon VALUES (4, 'Ares', 5, 'ogier', CONVERT(DATETIME,'2016/12/07'), 3, 2, 1);
INSERT INTO kon VALUES (5, 'Atena', 16, 'klacz', CONVERT(DATETIME,'2005/07/12'), 4, 3, 1);
INSERT INTO kon VALUES (6, 'Hades', 6, 'ogier', CONVERT(DATETIME,'2015/03/10'), 5, 1, 2);
INSERT INTO kon VALUES (7, 'Zeus', 6, 'ogier', CONVERT(DATETIME,'2015/12/11'), 6, 5, 2);
...
--INSERT INTO wlasciciel_klub VALUES (1,4,CONVERT(DATETIME,'2018/08/12'),null);
--INSERT INTO wlasciciel_klub VALUES (2,5,CONVERT(DATETIME,'2013/05/06'),null);
--INSERT INTO wlasciciel_klub VALUES (2,6,CONVERT(DATETIME,'2009/08/12'),null);

--Zawody skokowe
INSERT INTO zawody_skokowe VALUES (1,CONVERT(DATETIME,'2019/08/12'), 1);
INSERT INTO zawody_skokowe VALUES (2,CONVERT(DATETIME,'2020/08/12'), 1);
INSERT INTO zawody_skokowe VALUES (3,CONVERT(DATETIME,'2016/12/07'), 1);
INSERT INTO zawody_skokowe VALUES (4,CONVERT(DATETIME,'2013/05/06'), 1);
INSERT INTO zawody_skokowe VALUES (5,CONVERT(DATETIME,'2020/08/12'), 2);
